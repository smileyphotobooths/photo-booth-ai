...
# ✅ Reference images with white-ish background
reference_images = [
    ...
    try:
        ...
        vision_prompt.append({
            ...
            "text": (
                ...
                "Focus on skin tones, brightness, and clarity. Ignore the backdrop."
            )
        })
        ...
        vision_prompt.append({
            ...
            "text": (
                ...
                "If the test image appears even *slightly* darker or less vivid than the reference examples, always recommend brightening.\n\n"
                "✅ Important: If a photo appears darker than any of the reference examples, assume Jeremy would NOT approve it. "
                "Do not say 'this is close enough' — instead, clearly suggest increasing brightness.\n\n"
